...
import { FormTypeProps, setFormGroupProps } from '@/common/types/form';
import StackInspectionFormGroup from '@/features/introspections/components/StackInspectionFormGroup';
...
import TeamFormGroup from '@/features/teams/components/TeamFormGroup';
import InviteTeamFormGroup from '@/features/users/register/components/InviteTeamFormGroup';
import { FormContext } from '@/context/FormContext';
import { FormDataContext } from '@/context/FormDataContext';
import { resetFormValue } from '@/common/functions/form';
import { callCreateIntrospection,
  callCreateStack,
  callCreateTeam,
  callInviteTeam,
  callUpdateIntrospection,
  callUpdateTeam,
  callUpdateUser, } from '@/common/functions/api';
import { getApiHeaders } from '@/common/functions/api';
import { dataConfirmAlert } from '@/common/functions/form';
import FormSubmitButton from '../ui-elements/FormSubmitButton';
import FormCancelButton from '../ui-elements/FormCancelButton';
import OutputFormGroup from '@/features/outputs/components/OutputFormGroup';
import OutputCommentFormGroup from '@/features/outputs/comments/components/OutputCommentFormGroup';
import { callCreateOutput } from '@/features/outputs/functions/outputs';
import { callCreateOutputComment } from '@/features/outputs/comments/functions/comments';
